...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title=f'Total Launchs for {entered_site}')
        return fig
# TASK 4:
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(specific_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                         title=f'Payload Mass vs. Outcome for {entered_site}')
        
    # Update x-axis range based on payload range slider
